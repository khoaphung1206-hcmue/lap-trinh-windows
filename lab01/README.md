...
## Cách chạy
1. Mở file `Lab01_ThongTinCaNhan.sln` bằng Visual Studio.
2. Nhấn `F5` (hoặc nút Start) để build và chạy ứng dụng.

## Hình ảnh minh họa

**1. Hiển thị thông tin thành công**
![Hiển thị thông tin thành công](images/1_hien_thi_thanh_cong.png)

**2. Kiểm tra dữ liệu: Lỗi chọn giới tính**
![Lỗi chọn giới tính](images/2_loi_gioi_tinh.png)

**3. Kiểm tra dữ liệu: Lỗi năm sinh**
![Lỗi năm sinh](images/3_loi_nam_sinh.png)

**4. Hộp thoại xác nhận khi thoát**
![Xác nhận thoát](images/4_xac_nhan_thoat.png)
